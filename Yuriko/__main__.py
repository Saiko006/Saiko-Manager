...
yurikorobot_IMG = "https://telegra.ph/file/3159ae72221741d6f0d91.jpg"
...
def yurikorobot_about_callback(update, context):
    ...
    if query.data == "yurikorobot_":
                ...
                [
                    [
                        InlineKeyboardButton(
                            text=gs(chat.id,"bugs_button"), url="t.me/Kekiniangroup"
                        ),
                        InlineKeyboardButton(
                            text=gs(chat.id, "botlist_button"), url="https://t.me/musickekiniaan/56"
                        ),
                    ],
                    [InlineKeyboardButton(text=gs(chat.id, "back_button"), callback_data="yurikorobot_back")],
                ]
            ),
        )
        ...
        query.message.edit_text(
            text=gs(chat.id, "pm_basic_help"),
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text=gs(chat.id, "admin_button"), callback_data="yurikorobot_admin"),
                    InlineKeyboardButton(text=gs(chat.id, "notes_button"), callback_data="yurikorobot_notes"),
                 ],
                 [
                    InlineKeyboardButton(text=gs(chat.id, "support_button"), callback_data="yurikorobot_support"),
                    InlineKeyboardButton(text=gs(chat.id, "credit_button"), callback_data="yurikorobot_credit"),
                 ],
                 [
                    InlineKeyboardButton(text=gs(chat.id, "back_button"), callback_data="yurikorobot_back"),
        ...
        query.message.edit_text(
            text=gs(chat.id, "pm_basic_admin_text"),
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            text=gs(chat.id, "pm_basic_support_text"),
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text=gs(chat.id, "support_button"), url="t.me/Kekiniangroup"),
                    InlineKeyboardButton(text=gs(chat.id, "channel_button"), url="https://t.me/musickekiniaan"),
                 ],
                 [
                    InlineKeyboardButton(text=gs(chat.id, "back_button"), callback_data="yurikorobot_basichelp"),
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    ...
                    InlineKeyboardButton(text=gs(chat.id, "support_button"), url="https://t.me/Kekiniangroup"),
                 ],
                 [
                    InlineKeyboardButton(text=gs(chat.id, "back_button"), callback_data="yurikorobot_basichelp"),
...
def get_help(update: Update, context: CallbackContext):
    ...
    if chat.type != chat.PRIVATE:
        if len(args) >= 2 and any(args[1].lower() == x for x in HELPABLE):
            module = args[1].lower()
            update.effective_message.reply_text(
                text=gs(chat.id, "group_help_modules_text"),
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
        ...
        update.effective_message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            text=gs(chat.id, "support_button"),
...
def send_settings(chat_id, user_id, user=False):
    if user:
        ...
        if CHAT_SETTINGS:
            ...
            dispatcher.bot.send_message(
                user_id,
                text=gs(chat.id, "pm_settings_group_text").format(
                    chat_name
                ),
                reply_markup=InlineKeyboardMarkup(
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 2075788563 and DONATION_LINK:
            update.effective_message.reply_text(
