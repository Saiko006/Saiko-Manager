...
× /admin `<title>`: Promotes the user replied to.
...
PROMOTE_HANDLER = CommandHandler(
    "admin", promote, pass_args=True, filters=Filters.chat_type.groups, run_async=True
)
...
DEMOTE_HANDLER = CommandHandler(
    "unadmin", demote, pass_args=True, filters=Filters.chat_type.groups, run_async=True
)
