                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/KekinianOfficial/4"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/KekinianOfficial/7")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>╔═━「 Current Kekinian Robot Statistics 」</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
...
✪ /setbio - `This user is a` *KEKINIAN* `Member (reply to the user)`
